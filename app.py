...
def _patch_event_loop_close():
    orig_handler = asyncio.get_event_loop().get_exception_handler()

    def filtered_handler(context):
    ...
    try:
        ...
        loop.set_exception_handler(filtered_handler)
    except RuntimeError:
        pass

_patch_event_loop_close()
